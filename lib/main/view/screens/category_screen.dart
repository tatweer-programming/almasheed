                                  ...
                                  return AlertDialog(
                                    ...
                                    content: Column(
                                      ...
                                      children: [
                                        iconText(onTap: (){
                                          bloc.add(CancelSortProductsEvent(products: category.products!));
                                          bloc.add(const SortProductsEvent(type: "Alphabet"));
                                          context.pop();
                                        },text: "Alphabet", icon: Icons.sort_by_alpha),
                                        SizedBox(height: 1.h,),
                                        iconText(onTap: (){
                                          bloc.add(CancelSortProductsEvent(products: category.products!));
                                          bloc.add(const SortProductsEvent(type: "Lowest to highest price"));
                                          context.pop();
                                        },text: "Lowest to highest price", icon: Icons.arrow_upward_rounded),
                                        SizedBox(height: 1.h,),
                                        iconText(onTap: (){
                                          bloc.add(CancelSortProductsEvent(products: category.products!));
                                          bloc.add(const SortProductsEvent(type: "Highest to lowest price"));
                                          context.pop();
                                        },text: "Highest to lowest price", icon: Icons.arrow_downward_rounded),
                                      ],
                                    )
                                  );
                                },
...
Widget iconText({required String text,required IconData icon,required VoidCallback onTap})=>InkWell(
  onTap: onTap,
  child: Container(
